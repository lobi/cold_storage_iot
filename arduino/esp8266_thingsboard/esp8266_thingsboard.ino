...
// UART - to send serial data to 8051
#include <SoftwareSerial.h>
//SoftwareSerial myUART(3, 1); // RX, TX
SoftwareSerial myUART(13, 15); // RX, TX
...
// FAI'S HUB 2.4Ghz P.203 | Fptacademy@2023
// BALOI | 0909286456
#if THINGSBOARD_ENABLE_PROGMEM
constexpr char WIFI_SSID[] PROGMEM = "BALOI";
constexpr char WIFI_PASSWORD[] PROGMEM = "0909286456";
#else
constexpr char WIFI_SSID[] = "BALOI";
constexpr char WIFI_PASSWORD[] = "0909286456";
#endif

// See https://thingsboard.io/docs/getting-started-guides/helloworld/
// to understand how to obtain an access token
#if THINGSBOARD_ENABLE_PROGMEM
constexpr char TOKEN[] PROGMEM = "8okhjv3nvlopbm5c5hg3";
#else
constexpr char TOKEN[] = "8okhjv3nvlopbm5c5hg3";
#endif
...
void setup() {
  ...
  /*** UART ***/
  myUART.begin(9600); //same with 8051
  myUART.println("Hello, world?");
...
void loop() {
  ...
  /* UART - RX */
  // if data is available in the buffer of RX, let read it
  if (myUART.available()) 
  {
    // print it out for debug
    Serial.println("From 8051:");
  ...
  //myUART.write("ESP8266/");

  //int workingMode

  // UART - TX: send current working mode from Thingsboard to 8051
  // myUART.write('m');
  // myUART.write(':');
  // myUART.write(workingMode);
  // myUART.write("/"); // [slash] to indicate an ending of command


  //if (myUART.available())
    //myUART.write("ESP8266/");
  //else if (Serial.available()) 
    //Serial.println(myUART.read());
  //return;
